# Engram — root context for Claude Code

Engram cures the *collector's fallacy*: it turns a static second brain (Notion / Obsidian
vaults, uploaded notes) into durable memory via AI-orchestrated, gamified spaced repetition.

- **Design source of truth:** `docs/V1-spec.md` — read it before writing code.
